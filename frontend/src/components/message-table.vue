<template>
  <div>
    <el-table
      ...
      :row-style="({row, rowIndex}) => {if (type==4&&row.urge) return {color: 'red'}}"
    >
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button
            v-if="type==2&&scope.row.status==3"
            size="mini"
            type="primary"
            @click.stop="handleReturn(scope.$index, scope.row)">归还</el-button>
          <el-button
            v-if="type==3&&scope.row.urge==1"
            size="mini"
            type="primary"
            @click.stop="handleUrge(scope.$index, scope.row)">催办</el-button>
          <span v-if="type==3&&scope.row.urge==2">已催办</span>
          <span v-if="type==3&&scope.row.urge==3">等待审批</span>
          <el-button
            v-if="type==4&&scope.row.status==0"
            size="mini"
            type="primary"
          ...
          <el-button
            v-if="type==4&&scope.row.status==4"
            size="mini"
            type="primary"
